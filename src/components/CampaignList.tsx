...
import logoPrefeituraSP from '../images/prefeitura_sp_logo.png';
...
const clientLogos: Record<string, string> = {
  ...
  'Sebrae': logoSebrae,
  'SEBRAE': logoSebrae,
  'Municipio de São Paulo': logoPrefeituraSP,
  'Município de São Paulo': logoPrefeituraSP,
  'MUNICIPIO DE SAO PAULO': logoPrefeituraSP,
  'Municipio de Sao Paulo': logoPrefeituraSP
};
